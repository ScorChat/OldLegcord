...
import { Sparkles, ChevronLeft, ChevronRight, Settings, Monitor, Box, MinimizeIcon, PuzzleIcon, LaptopMinimalCheck, LaptopMinimal, CircleAlert } from 'lucide-react'
    ...
    <div class="space-y-6">
      ...
      <div class="space-y-4">
        <div class="p-4 rounded-xl bg-yellow-500/10 border border-yellow-500/20 flex items-center gap-3">
          ...
          <div>
            <p class="text-yellow-200/80 text-sm mt-0.5">System tray functionality may have issues or behave differently on Linux systems.</p>
          </div>
        </div>
  ...
  return (
    <div class="space-y-6">
      <div class="text-center">
        ...
        <p class="text-gray-400">Legcord includes Shelter out of the box, but you can also choose another client mod if wanted.</p>
      </div>
      ...
      {(mod) =>
          ...
          >
            <div class="flex items-start gap-4">
              <div class={`w-10 h-10 rounded-lg transition-colors overflow-hidden ${
                selectedMod() === mod.id
                  ? "bg-purple-500/20"
                  : "bg-gray-800/40"
              }`}>
    ...
    <div class="min-h-screen flex items-center justify-center">
      ...
      >
        <CurrentStepComponent 
          ...
          onStateUpdate={
            // @ts-expect-error
            currentStep() === 1 ? handleStateUpdate('windowStyle') :
            // @ts-expect-error
            currentStep() === 3 ? handleStateUpdate('traySettings') :
            undefined
          }
        />
